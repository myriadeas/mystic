 ...
 */
enum SafeHtmlTreeBuilderState {
    Initial {
        boolean process(Token t, SafeHtmlTreeBuilder tb) {
            if (isWhitespace(t)) {
    ...
    BeforeHtml {
        ...
        private boolean anythingElse(Token t, SafeHtmlTreeBuilder tb) {
        	throw new IllegalArgumentException("May not be a HTML document.");
        	/*
            tb.insert("html");
            tb.transition(BeforeHead);
            return tb.process(t);
    ...
    InBody {
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (name.equals("html")) {
                        ...
                        SafeHtmlTreeBuilderState state = tb.state();
        ...
        boolean anyOtherEndTag(Token t, SafeHtmlTreeBuilder tb) {
    ...
    InTable {
        ...
        boolean anythingElse(Token t, SafeHtmlTreeBuilder tb) {
            tb.error(this);
    ...
    InTableBody {
        ...
        private boolean exitTableBody(Token t, SafeHtmlTreeBuilder tb) {
    ...
    InCell {
        ...
        private void closeCell(SafeHtmlTreeBuilder tb) {
    ...
    abstract boolean process(Token t, SafeHtmlTreeBuilder tb);
    ...
    private static void handleRcData(Token.StartTag startTag, SafeHtmlTreeBuilder tb) {
        tb.insert(startTag);
        tb.tokeniser.transition(TokeniserState.Rcdata);
        tb.markInsertionMode();
        tb.transition(Text);
    ...
    private static void handleRawtext(Token.StartTag startTag, SafeHtmlTreeBuilder tb) {
        tb.insert(startTag);
